    ...
    <el-aside :width="isCollapsed ? '72px' : '240px'" class="sidebar">
      <div class="logo-area">
        ...
        <transition name="fade">
          <span v-if="!isCollapsed" class="logo-text">教师端</span>
        </transition>
      </div>
      ...
      <el-header class="header">
        ...
        <div class="header-right">
          <div class="user-dropdown" @click="showUserMenu = !showUserMenu">
            <div class="user-avatar" :style="{ background: 'linear-gradient(135deg, #34A853, #1E8449)' }">
...
.sidebar {
  background: linear-gradient(180deg, #34A853 0%, #1E8449 100%);
