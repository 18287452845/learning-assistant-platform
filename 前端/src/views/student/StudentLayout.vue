    ...
    <el-aside :width="isCollapsed ? '72px' : '240px'" class="sidebar">
      <div class="logo-area">
        ...
        <transition name="fade">
          <span v-if="!isCollapsed" class="logo-text">知行学堂</span>
        </transition>
      </div>
      ...
      >
        ...
        <el-menu-item index="/student/qa/history">
          <span class="menu-dot"></span>
          <span>问答历史</span>
        </el-menu-item>
        ...
        <el-menu-item index="/student/learning-plan">
          <span class="menu-dot"></span>
          <span>学习计划</span>
        </el-menu-item>
      ...
      <el-header class="header">
        ...
        <div class="header-right">
          <div class="user-dropdown" @click="showUserMenu = !showUserMenu">
            <div class="user-avatar" :style="{ background: 'linear-gradient(135deg, #FF8C42, #FF6B35)' }">
            ...
            <transition name="dropdown">
              <div class="dropdown-menu" v-if="showUserMenu" @click.stop>
                ...
                <div class="dropdown-item" @click="handleCommand('settings')">设置</div>
...
const handleCommand = async (command) => {
  ...
  switch (command) {
    case 'profile':
      ...
      break
    case 'settings':
      router.push('/student/profile?tab=settings')
      break
    case 'logout':
      try {
